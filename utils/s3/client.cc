...
void client::group_client::register_metrics(std::string class_name, std::string host) {
    ...
    metrics.add_group("s3", {
        ...
        sm::make_counter("total_read_prefetch_bytes", [this] { return prefetch_bytes; },
                sm::description("Total number of bytes prefetched in advance"), {ep_label, sg_label}),
        sm::make_counter("total_prefetch_early_aborts", [this] { return prefetch_early_aborts; },
                sm::description("Total number of times prefetch was aborted early"), {ep_label, sg_label}),
    });
}
