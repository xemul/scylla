...
class region_impl final : public basic_region_impl {
    ...
    public:
        ...
        segment::size_type encoded_size() const {
            return utils::uleb32_encoded_size(_n) + 1; // 0 is illegal
        }

        void encode(char*& pos) const {
            utils::uleb32_encode(pos, _n, poison<char>, unpoison);
        }
        ...
        void encode(char*& pos, size_t encoded_size) const {
            utils::uleb32_encode(pos, _n, encoded_size, poison<char>, unpoison);
        }

        static object_descriptor decode_forwards(const char*& pos) {
            return object_descriptor(utils::uleb32_decode_forwards(pos, poison<char>, unpoison));
        }

        static object_descriptor decode_backwards(const char*& pos) {
            return object_descriptor(utils::uleb32_decode_bacwards(pos, poison<char>, unpoison));
        }
