    ...
    return do_with_cql_env_thread([] (cql_test_env& e) {
        ...
        std::unordered_map<std::string, std::string> cql_create_tables {
          {"cf_view", "CREATE MATERIALIZED VIEW \"KS\".cf_view AS\n"
              ...
              "    AND paxos_grace_seconds = 43200\n"
              "    AND tombstone_gc = {'mode': 'timeout', 'propagation_delay_in_seconds': '3600'};\n"},
          {"cf_index_index", "CREATE INDEX cf_index ON \"KS\".\"cF\"(col2) WITH bloom_filter_fp_chance = 0.01\n"
              "    AND caching = {'keys': 'ALL', 'rows_per_partition': 'ALL'}\n"
              "    AND comment = ''\n"
          ...
          {"cf_index1_index", "CREATE INDEX cf_index1 ON \"KS\".\"cF\"(pk) WITH bloom_filter_fp_chance = 0.01\n"
              "    AND caching = {'keys': 'ALL', 'rows_per_partition': 'ALL'}\n"
              "    AND comment = ''\n"
              "    AND compaction = {'class': 'IncrementalCompactionStrategy'}\n"
              "    AND compression = {'sstable_compression': 'org.apache.cassandra.io.compress.LZ4Compressor'}\n"
              ...
              "    AND tombstone_gc = {'mode': 'timeout', 'propagation_delay_in_seconds': '3600'}\n"
              "    AND synchronous_updates = true;"},
          {"cf_index2_index", "CREATE INDEX cf_index2 ON \"KS\".\"cF\"(pk1) WITH bloom_filter_fp_chance = 0.01\n"
              "    AND caching = {'keys': 'ALL', 'rows_per_partition': 'ALL'}\n"
              "    AND comment = ''\n"
              "    AND compaction = {'class': 'IncrementalCompactionStrategy'}\n"
              "    AND compression = {'sstable_compression': 'org.apache.cassandra.io.compress.LZ4Compressor'}\n"
              ...
              "    AND tombstone_gc = {'mode': 'timeout', 'propagation_delay_in_seconds': '3600'}\n"
              "    AND synchronous_updates = true;"},
          {"cf_index3_index", "CREATE INDEX cf_index3 ON \"KS\".\"cF\"(ck1) WITH bloom_filter_fp_chance = 0.01\n"
              "    AND caching = {'keys': 'ALL', 'rows_per_partition': 'ALL'}\n"
              "    AND comment = ''\n"
              "    AND compaction = {'class': 'IncrementalCompactionStrategy'}\n"
              "    AND compression = {'sstable_compression': 'org.apache.cassandra.io.compress.LZ4Compressor'}\n"
              ...
              "    AND tombstone_gc = {'mode': 'timeout', 'propagation_delay_in_seconds': '3600'}\n"
              "    AND synchronous_updates = true;"},
          {"cf_index4_index", "CREATE INDEX cf_index4 ON \"KS\".\"cF\"((pk, pk1),col2) WITH bloom_filter_fp_chance = 0.01\n"
              "    AND caching = {'keys': 'ALL', 'rows_per_partition': 'ALL'}\n"
              "    AND comment = ''\n"
              "    AND compaction = {'class': 'IncrementalCompactionStrategy'}\n"
              "    AND compression = {'sstable_compression': 'org.apache.cassandra.io.compress.LZ4Compressor'}\n"
