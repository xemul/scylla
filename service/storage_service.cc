...
storage_service::storage_service(abort_source& abort_source, distributed<database>& db, gms::gossiper& gossiper, sharded<db::system_distributed_keyspace>& sys_dist_ks,
        ...
        , _snitch_reconfigure(&storage_service::snitch_reconfigured, this)
...
void storage_service::snitch_reconfigured() {
    update_topology(utils::fb_utilities::get_broadcast_address()).get();
}
